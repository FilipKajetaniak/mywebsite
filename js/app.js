...
var changeStyles = function changeStyles(element) {
    if (element === 'about') {
        line.style.left = '50px';
        line.style.width = '54px';
    } else if (element === 'work') {
        line.style.left = '134px';
        line.style.width = '47px';
    } else if (element === 'contact') {
        line.style.left = '211px';
...
var resetLine = function resetLine() {
    if (!active) {
        line.style.left = '50px';
...
about.addEventListener('mouseleave', resetLine);
work.addEventListener('mouseover', function (e) {
    moveLine(e);
});
work.addEventListener('mouseleave', resetLine);
contact.addEventListener('mouseover', function (e) {
    moveLine(e);
});
contact.addEventListener('mouseleave', resetLine);
...
mobileMenu.getElementsByTagName('a')[0].addEventListener('click', function () {
    hideMobileMenu();
    window.location.hash = 'about';
});
mobileMenu.getElementsByTagName('a')[1].addEventListener('click', function () {
    hideMobileMenu();
    window.location.hash = 'work';
});
mobileMenu.getElementsByTagName('a')[2].addEventListener('click', function () {
    hideMobileMenu();
    window.location.hash = 'contact';
});
...
var loadArticle = function loadArticle(project) {
...
var addListeners = function addListeners() {
    ...
    projects.forEach(function (project) {
        project.getElementsByTagName('h1')[0].addEventListener('click', function (e) {
...
var router = function router() {
    ...
    (0, _render2.default)(url);
    if (url === 'dziecimamy' || url === 'kajetaniak' || url === 'stock' || url === 'novak') {
        _nav2.default.setActive('work');
        _nav2.default.updateLine('work');
        return;
    }
    _nav2.default.setActive(url);
    _nav2.default.updateLine(url);
};
...
var _work = __webpack_require__(333);
...
var _contact = __webpack_require__(335);
...
var _dziecimamy = __webpack_require__(337);

var _dziecimamy2 = _interopRequireDefault(_dziecimamy);

var _portfolio = __webpack_require__(338);

var _portfolio2 = _interopRequireDefault(_portfolio);

var _stock = __webpack_require__(339);

var _stock2 = _interopRequireDefault(_stock);

var _novak = __webpack_require__(340);

var _novak2 = _interopRequireDefault(_novak);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var slot = document.getElementById('slot');

var renderArticle = function renderArticle(component) {
    ...
    setTimeout(function () {
        ...
        if (component === 'dziecimamy') {
            (0, _dziecimamy2.default)(slot);
        } else if (component === 'kajetaniak') {
            (0, _portfolio2.default)(slot);
        } else if (component === 'stock') {
            (0, _stock2.default)(slot);
        } else if (component === 'novak') {
            (0, _novak2.default)(slot);
        }
    }, 100);
    setTimeout(function () {
...
var render = function render(component) {
    if (component === 'dziecimamy' || component === 'novak' || component === 'stock' || component === 'kajetaniak') {
    ...
    setTimeout(function () {
        ...
        window.scrollTo(0, 0);
        if (component === 'work') {
            (0, _work2.default)(slot);
            (0, _article2.default)();
        } else if (component === 'about') {
            (0, _about2.default)(slot);
        } else if (component === 'contact') {
            (0, _contact2.default)(slot);
        } else if (component === '') {
            (0, _home2.default)(slot);
        }
        slot.style.transform = 'translateX(25px)';
    }, 100);
    setTimeout(function () {
...
var createProjects = function createProjects(element) {
    ...
    var novak = document.createElement('div');
...
exports.default = createProjects;
...
var createAbout = function createAbout(element) {
    var h1 = document.createElement('h1');
    var p1 = document.createElement('p');
    h1.innerText = 'In a nutshell 🥜';
    p1.innerText = 'My name is Filip Kajetaniak and I\'m looking for a junior front-end web developer position. I\'m 22 years old. I\'m based in Warsaw (but I\'m willing to move if necessary). I design and build web apps with HTML, CSS, JavaScript and Vue.js.';
...
var createContact = function createContact(element) {
    var container = document.createElement('div');
    container.classList.add('content');
    var section = document.createElement('section');
...
var createHome = function createHome(element) {
    var container = document.createElement('div');
    container.classList.add('content');
...
var createPortfolio = function createPortfolio(element) {
  var container = document.createElement('div');
  container.classList.add('content');
  var article = document.createElement('article');
...
var createStock = function createStock(element) {
  var container = document.createElement('div');
  container.classList.add('content');
  var article = document.createElement('article');
...
var createNovak = function createNovak(element) {
  var container = document.createElement('div');
  container.classList.add('content');
  var article = document.createElement('article');
